...
// STORY_GEN_BEGIN
// Story-flaggor från story/milestones.json (genererat av tools/story/gen_story.py)
#define FLAG_STORY_JOHTO_STARTER_RECEIVED        FLAG_UNUSED_0x020 // Spelaren har fått sin starter av Elm
#define FLAG_STORY_JOHTO_CHAMPION                FLAG_UNUSED_0x021 // Johtos Elite 4 och Lance besegrade
#define FLAG_STORY_KANTO_UNLOCKED                FLAG_UNUSED_0x022 // S.S. Aqua / vägen till Kanto öppen
#define FLAG_STORY_KANTO_ALL_BADGES              FLAG_UNUSED_0x023 // Alla 8 Kanto-badges
#define FLAG_STORY_HOENN_UNLOCKED                FLAG_UNUSED_0x024 // Resan till Hoenn är öppen
#define FLAG_STORY_HOENN_CHAMPION                FLAG_UNUSED_0x025 // Hoenns Elite 4 besegrade
// STORY_GEN_END
...
// Crystal-flaggor (EVENT_*) mappade till oanvända Emerald-flaggor – genererat av tools/crystal_import
#define EVENT_CHIKORITA_POKEBALL_IN_ELMS_LAB FLAG_UNUSED_0x031
#define EVENT_COP_IN_ELMS_LAB FLAG_UNUSED_0x032
#define EVENT_CYNDAQUIL_POKEBALL_IN_ELMS_LAB FLAG_UNUSED_0x02F
#define EVENT_ELMS_AIDE_IN_LAB FLAG_UNUSED_0x02E
#define EVENT_GUIDE_GENT_IN_HIS_HOUSE FLAG_UNUSED_0x036
#define EVENT_GUIDE_GENT_VISIBLE_IN_CHERRYGROVE FLAG_UNUSED_0x038
#define EVENT_PLAYERS_HOUSE_1F_NEIGHBOR FLAG_UNUSED_0x029
#define EVENT_PLAYERS_HOUSE_2F_BIG_DOLL FLAG_UNUSED_0x02D
#define EVENT_PLAYERS_HOUSE_2F_CONSOLE FLAG_UNUSED_0x02A
#define EVENT_PLAYERS_HOUSE_2F_DOLL_1 FLAG_UNUSED_0x02B
#define EVENT_PLAYERS_HOUSE_2F_DOLL_2 FLAG_UNUSED_0x02C
#define EVENT_PLAYERS_HOUSE_MOM_1 FLAG_UNUSED_0x027
#define EVENT_PLAYERS_HOUSE_MOM_2 FLAG_UNUSED_0x028
#define EVENT_PLAYERS_NEIGHBORS_HOUSE_NEIGHBOR FLAG_UNUSED_0x033
#define EVENT_RIVAL_CHERRYGROVE_CITY FLAG_UNUSED_0x037
#define EVENT_RIVAL_NEW_BARK_TOWN FLAG_UNUSED_0x026
#define EVENT_ROUTE_29_POTION FLAG_UNUSED_0x035
#define EVENT_ROUTE_29_TUSCANY_OF_TUESDAY FLAG_UNUSED_0x034
#define EVENT_TOTODILE_POKEBALL_IN_ELMS_LAB FLAG_UNUSED_0x030
// CRYSTAL_IMPORT_END
