...
// KANTO_IMPORT_BEGIN
// Kanto-sprites använder oanvända sprite-platser i Emerald
#define OBJ_EVENT_GFX_PROF_OAK OBJ_EVENT_GFX_UNUSED_NATU_DOLL
#define OBJ_EVENT_GFX_DAISY OBJ_EVENT_GFX_UNUSED_MAGNEMITE_DOLL
#define OBJ_EVENT_GFX_BLUE OBJ_EVENT_GFX_UNUSED_SQUIRTLE_DOLL
#define OBJ_EVENT_GFX_GIOVANNI OBJ_EVENT_GFX_UNUSED_WOOPER_DOLL
#define OBJ_EVENT_GFX_POKEDEX OBJ_EVENT_GFX_UNUSED_PIKACHU_DOLL
#define OBJ_EVENT_GFX_TOWN_MAP OBJ_EVENT_GFX_UNUSED_PORYGON2_DOLL
// KANTO_IMPORT_END
