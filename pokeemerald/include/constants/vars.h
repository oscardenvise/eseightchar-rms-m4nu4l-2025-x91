...
// KANTO_IMPORT_BEGIN
// Kanto-variabler från pokefirered, mappade till oanvända Emerald-variabler
#define VAR_MAP_SCENE_CERULEAN_CITY_RIVAL VAR_UNUSED_0x40B8
#define VAR_MAP_SCENE_PALLET_TOWN_OAK VAR_UNUSED_0x404E
#define VAR_MAP_SCENE_PALLET_TOWN_PLAYERS_HOUSE_2F VAR_UNUSED_0x409D
#define VAR_MAP_SCENE_PALLET_TOWN_PROFESSOR_OAKS_LAB VAR_UNUSED_0x408B
#define VAR_MAP_SCENE_PALLET_TOWN_RIVALS_HOUSE VAR_UNUSED_0x40A1
#define VAR_MAP_SCENE_PALLET_TOWN_SIGN_LADY VAR_UNUSED_0x4083
#define VAR_MAP_SCENE_POKEMON_CENTER_TEALA VAR_UNUSED_0x40DB
#define VAR_MAP_SCENE_ROUTE22 VAR_UNUSED_0x40DC
#define VAR_MAP_SCENE_VIRIDIAN_CITY_GYM_DOOR VAR_UNUSED_0x409B
#define VAR_MAP_SCENE_VIRIDIAN_CITY_MART VAR_UNUSED_0x40BB
#define VAR_MAP_SCENE_VIRIDIAN_CITY_OLD_MAN VAR_UNUSED_0x4091
#define VAR_MASSAGE_COOLDOWN_STEP_COUNTER VAR_UNUSED_0x40A8
// KANTO_IMPORT_END
